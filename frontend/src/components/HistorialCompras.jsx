...
function HistorialCompras() {
  ...
  return (
    <div className="container py-5">
      <h1 className="fw-bold mb-4 text-center"><i class="fa-solid fa-receipt"></i> Historial de Compras</h1>
      ...
      <h3 className="mt-4"><i class="fa-solid fa-headphones"></i> Canciones compradas</h3>
      <div className="row g-4">
        {canciones.length > 0 ? (
          canciones.map((c) => (
            <div className="col-md-4" key={c.compra_id}>
              <div className="card shadow-sm p-3">
                <h5 className="fw-bold">{c.titulo || c.nombre || `Canción #${c.cancion_id}`}</h5>
      ...
      <h3 className="mt-5"><i className="fa-solid fa-compact-disc"></i> Vinilos comprados</h3>
<div className="row g-4">
  {vinilos.length > 0 ? (
    vinilos.map((v) => (
